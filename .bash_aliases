...
alias pud='pushd'
alias pod='popd'
alias scancp='mount -t vfat -o umask=000 /dev/sdc1 /mnt/usb0 && cp /mnt/usb0/HPSCANS/scan*.pdf . && chmod 622 scan* && rm /mnt/usb0/HPSCANS/scan*.pdf && umount /dev/sdc1'
alias curl='curl -w "\n"'
alias gs='git status'
alias gti='git'
...
alias less='less -r'
alias kodi='/usr/lib/kodi/kodi-wayland'
