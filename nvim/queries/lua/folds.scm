(
  ...
  (#make-range-extended! "fold" @clause "end" 0 1 @for_stmt "end" 0 0)
...
(
  ...
  (#make-range-extended! "fold" @cond "end" 0 1 @if_stmt "end" 0 0)
...
(
  ...
  (#make-range-extended! "fold" @params "end" 0 1 @fn "end" 0 0)
  (#set! foldtext_start "")
...
(
  ...
  (#make-range-extended! "fold" @tc "start" 0 1 @tc "end" 0 -1)
)
...
(
 ...
 (#make-range-extended! "fold" @first "start" 0 0 @last "end" 0 0)
 (#set! foldtext_start "")
 (#set! foldtext_start_hl "")
 (#set! foldtext_end "")
 (#set! foldtext_end_hl "")
