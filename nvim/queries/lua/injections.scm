...
(function_call
  (dot_index_expression
    ...
    (#any-of? @_method "match" "gmatch" "gsub"))
  arguments: (arguments
    .
    (_)
    .
...
((function_call
  ...
  (#any-of? @_vimcmd_identifier "exec_lua")
  (#set! injection.language "lua"))
