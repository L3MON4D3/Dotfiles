...
vim.api.nvim_set_keymap('i', "<C-g>", '<cmd>lua require("plugins.luasnip.external_update_dynamic_node").dynamic_node_external_update(3)<Cr>', {noremap = true})
vim.api.nvim_set_keymap('s', "<C-g>", '<cmd>lua require("plugins.luasnip.external_update_dynamic_node").dynamic_node_external_update(3)<Cr>', {noremap = true})

vim.api.nvim_set_keymap('i', "<C-s-g>", '<cmd>lua require("plugins.luasnip.external_update_dynamic_node").dynamic_node_external_update(4)<Cr>', {noremap = true})
vim.api.nvim_set_keymap('s', "<C-s-g>", '<cmd>lua require("plugins.luasnip.external_update_dynamic_node").dynamic_node_external_update(4)<Cr>', {noremap = true})
