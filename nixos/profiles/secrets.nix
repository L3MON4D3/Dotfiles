...

{
  l3mon.secgen.secrets = {
    ...
    dsl_user = config.lib.l3mon.secgen.direct_secret {owner="simon"; id="easybell_user";};
    dsl_pw = config.lib.l3mon.secgen.direct_secret {owner="simon"; id="easybell_password";};
  };
}
